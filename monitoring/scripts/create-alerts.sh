...
create_alert "DocID Worker Down" '[
    {"refId":"A","relativeTimeRange":{"from":300,"to":0},"datasourceUid":"'$DS_UID'","model":{"expr":"count(up{job=\"doc-pipeline-api\"} == 1) or vector(0)"}},
...
create_alert "DocID High Error Rate" '[
    {"refId":"A","relativeTimeRange":{"from":300,"to":0},"datasourceUid":"'$DS_UID'","model":{"expr":"sum(rate(doc_pipeline_jobs_processed_total{job=\"doc-pipeline-api\",status=\"error\"}[5m])) / sum(rate(doc_pipeline_jobs_processed_total{job=\"doc-pipeline-api\"}[5m]))"}},
    {"refId":"B","datasourceUid":"__expr__","model":{"type":"threshold","expression":"A","conditions":[{"evaluator":{"type":"gt","params":[0.1]}}]}}
...
create_alert "DocID High Latency" '[
    {"refId":"A","relativeTimeRange":{"from":300,"to":0},"datasourceUid":"'$DS_UID'","model":{"expr":"histogram_quantile(0.95,sum(rate(doc_pipeline_worker_processing_seconds_bucket{job=\"doc-pipeline-api\"}[5m])) by (le))"}},
    {"refId":"B","datasourceUid":"__expr__","model":{"type":"threshold","expression":"A","conditions":[{"evaluator":{"type":"gt","params":[30]}}]}}
...
create_alert "DocID Queue Backup" '[
    {"refId":"A","relativeTimeRange":{"from":300,"to":0},"datasourceUid":"'$DS_UID'","model":{"expr":"max(doc_pipeline_queue_depth{job=\"doc-pipeline-api\"})"}},
    {"refId":"B","datasourceUid":"__expr__","model":{"type":"threshold","expression":"A","conditions":[{"evaluator":{"type":"gt","params":[10]}}]}}
...
create_alert "OCR Worker Down" '[
    {"refId":"A","relativeTimeRange":{"from":300,"to":0},"datasourceUid":"'$DS_UID'","model":{"expr":"up{job=\"doc-pipeline-api\"}"}},
    {"refId":"B","datasourceUid":"__expr__","model":{"type":"threshold","expression":"A","conditions":[{"evaluator":{"type":"lt","params":[1]}}]}}
